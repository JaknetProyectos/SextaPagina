      ...
      `}} />
            ...
            <section>
                ...
                <ul>
                    ...
                    <li><strong>Sitio web:</strong> <a href="http://www.exploratumexico.com/" title="http://www.exploratumexico.com/">turivana.com</a><br /><strong>2. Qué datos recopilamos y por qué los necesitamos</strong><br />Turivana no crea ni administra cuentas de usuario, perfiles en línea ni bases de datos de clientes registrados. El único canal de recopilación de datos personales es el formulario de contacto disponible en el sitio web, el cual se activa cuando un visitante desea conocer más sobre un servicio o solicitar una cotización. Los datos que solicitamos son:  </li>
    ...
    return (
      ...
      `}} />
            ...
            <section>
                ...
                <p><strong>CREZK DIGITAL STRATEGY S.A. DE C.V.</strong><br /><strong>Turivana</strong><br /><em>Last updated: </em> <em>April</em> <em> 2026</em><br /><strong>1. Who is responsible for your data</strong><br />Turivana is responsible for the processing of personal data collected through the website <a href="http://www.exploratumexico.com/" title="http://www.exploratumexico.com/">turivana.com</a>. We operate from Mexico City and provide services for the design, production, and coordination of romantic, photographic, and entertainment experiences in destinations across the Mexican Republic.<br />Identification details of the data controller: </p>
                <ul>
                    <li><strong>Company: </strong>CREZK DIGITAL STRATEGY S.A. DE C.V. </li>
                    <li><strong>Tax ID (RFC):</strong> CED2303235KA </li>
                    <li><strong>Trade name:</strong> TURIVANA </li>
                    <li><strong>Address:</strong> Calle Río Guadiana No. 23, Floor 2, Col. Renacimiento, Cuauhtémoc Borough, ZIP Code 06500, Mexico City, CDMX. </li>
                    ...
                    <li><strong>Website:</strong> <a href="http://www.exploratumexico.com/" title="http://www.exploratumexico.com/">turivana.com</a><br /><strong>2. What data we collect and why we need it</strong><br />Turivana does not create or manage user accounts, online profiles, or databases of registered customers. The only channel for collecting personal data is the contact form available on the website, which is activated when a visitor wishes to learn more about a service or request a quote. The data we request are: </li>
                    <li><strong>Full name:</strong> to identify the requester and personalize the service. </li>
                    <li><strong>Email address:</strong> to send a response to the request and, if applicable, reservation confirmation. </li>
                    ...
                    <li><strong>Number of people:</strong> to scale the production of the service. </li>
                    <li><strong>Message or experience description:</strong> to understand the specific needs of the requester.<br />We do not collect payment data directly through the contact form. Payments are processed through external payment platforms (Visa and Mastercard), and Turivana does not store, retain, or have access to the customer’s banking or card data.<br />If the service is contracted and an invoice is required, we may request additional tax information (e.g., RFC and tax address) solely for invoicing purposes<br /><strong>3. What we use your information for</strong><br />The data collected have the following primary purposes, without which we could not process your request: </li>
                    <li>Respond to the request for information or quotation submitted through the contact form. </li>
                    ...
                    <li>Process and confirm payment once the service terms are agreed.<br />As a secondary purpose and subject to your express consent, we may use your email address to send you information about new experiences, special promotions, or updates to our service catalog. You may revoke this consent at any time by writing to <a href="mailto:%20hello@exploratumexico.com" title="mailto:%20hello@exploratumexico.com">contacto@turivana.com.</a><br /><strong>4. Your consent</strong><br />By completing and submitting the contact form available at <a href="http://www.exploratumexico.com/" title="http://www.exploratumexico.com/">turivana.com</a>, the user grants consent for the processing of their personal data in accordance with the terms of this Privacy Policy, in compliance with Article 8 of the Federal Law on Protection of Personal Data Held by Private Parties (LFPDPPP).<br />Turivana does not request sensitive personal data as defined in Article 3, Section VI of the LFPDPPP, nor data from minors.<br /><strong>5. Your ARCO rights</strong><br />In accordance with Articles 28 to 37 of the LFPDPPP, you have the right to: </li>
                    <li><strong>Access:</strong> know what data we hold about you and how we use it. </li>
                    <li><strong>Rectification:</strong> request correction of inaccurate or incomplete data. </li>
                    <li><strong>Cancellation:</strong> request deletion of your data when it is no longer necessary for the purpose for which it was collected. </li>
                    <li><strong>Objection:</strong> object to the processing of your data for secondary purposes.<br />To exercise any of these rights, send your request to <a href="mailto:hello@exploratumexico.com" title="mailto:hello@exploratumexico.com">contacto@turivana.com</a> or in writing to our address at Calle Río Guadiana No. 23, Floor 2, Col. Renacimiento, Cuauhtémoc Borough, ZIP Code 06500, Mexico City, indicating your full name, the right you wish to exercise, and a description of the related data.<br />We will respond within a maximum of 20 business days in accordance with Article 32 of the LFPDPPP and, if the request is deemed valid, we will carry it out within the following 15 business days<br /><strong>6. Transfer of your data to third parties</strong><br />Turivana may share your personal data only with the following third parties, strictly as necessary to provide the contracted service: </li>
                    ...
                    <li>Authorized payment processors (Visa/Mastercard networks): exclusively to manage the financial transaction.<br />We do not share your information with third parties for commercial or advertising purposes unrelated to service delivery. Transfers are carried out in accordance with Article 37 of the LFPDPPP, and third parties are obligated to maintain the confidentiality of your data.<br /><strong>7. How we protect your information</strong><br />Turivana implements administrative, technical, and physical security measures to protect your personal data against damage, loss, alteration, destruction, or unauthorized access, in accordance with Article 19 of the LFPDPPP. Access to your information is restricted only to authorized personnel who need it to process your request.<br /><strong>8. Cookies and tracking technologies</strong><br />The site <a href="http://www.exploratumexico.com/" title="http://www.exploratumexico.com/">turivana.com</a> may use session cookies and web analytics tools (such as Google Analytics) to measure site traffic and improve the browsing experience. These technologies do not collect personally identifiable data.<br />You can configure your browser to reject cookies; however, this may affect site functionality.<br /><strong>9. Changes to this Privacy Policy</strong><br />Turivana reserves the right to update this Privacy Policy at any time. Any modification will be published on <a href="http://www.exploratumexico.com/" title="http://www.exploratumexico.com/">turivana.com</a> indicating the update date. Continued use of the website after changes are published implies acceptance of such changes. If additional purposes or transfers requiring your consent are introduced, we will request it explicitly before processing your data for those new purposes<br />This policy was last updated in March 2026 and is based on the Federal Law on Protection of Personal Data Held by Private Parties, published in the Official Gazette of the Federation on July 5, 2010, and its Regulations published on December 21, 2011. </li>
                </ul>
