          ...
          <div className="space-y-8">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-gray-900 mt-6 leading-tight">
                Personalizamos cada <br />
                <span className="text-green-400">detalle de tu viaje</span>
              </h2>
            </div>
              ...
              <div className="flex gap-4 items-start relative z-10">
                ...
                <div>
                  ...
                  <p className="text-gray-700 font-medium leading-relaxed">
                    Nuestros servicios están disponibles en los mejores destinos de México. 
                    Puedes agregar elementos adicionales con una cotización personalizada según tus sueños.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative w-full max-w-md aspect-square bg-gray-50 rounded-[60px] flex items-center justify-center overflow-hidden">
              <svg viewBox="0 0 300 300" className="w-4/5 h-4/5" fill="none">
                ...
                <g transform="translate(235, 85) rotate(-50)">
                  <path
                    d="M0 10 L30 0 L30 6 L10 10 L30 14 L30 20 Z"
                    fill="#111827"
                  />
                </g>
